...
public:
  ...
  inline bool fromPlanarRefractionInfo( const jir_refractive_image_geometry_msgs::msg::PlanarRefractionInfo::ConstSharedPtr& info) {
		return fromPlanarRefractionInfo(*info);
	}
	inline bool fromPlanarRefractionInfo( const jir_refractive_image_geometry_msgs::msg::PlanarRefractionInfo& info) {
...
protected:
	jir_refractive_image_geometry_msgs::msg::PlanarRefractionInfo planarRefractionInfo;
