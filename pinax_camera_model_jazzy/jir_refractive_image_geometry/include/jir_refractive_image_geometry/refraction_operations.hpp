...
#include <jir_refractive_image_geometry_msgs/msg/planar_refraction_info.hpp>
...
void refract(const Ray<Scalar>& input, const jir_refractive_image_geometry_msgs::msg::PlanarRefractionInfo& params, Ray<Scalar>& output) {
...
template< typename Derived >
void point_on_inside_of_refractive_plane_analytic(const MatrixBase<Derived>& in_outside_point, const jir_refractive_image_geometry_msgs::msg::PlanarRefractionInfo& params, MatrixBase<Derived>& out_inside_point) {
	typedef typename internal::traits<Derived>::Scalar Scalar;
...
template < typename Derived >
typename internal::traits<Derived>::Scalar distance(typename internal::traits<Derived>::Scalar x, const MatrixBase<Derived>& p, const jir_refractive_image_geometry_msgs::msg::PlanarRefractionInfo& params) {
	typedef typename internal::traits<Derived>::Scalar Scalar;
...
template < typename Derived >
void write_3d_point(typename internal::traits<Derived>::Scalar x, const MatrixBase<Derived>& in_outside_point, const jir_refractive_image_geometry_msgs::msg::PlanarRefractionInfo& params, MatrixBase<Derived>& out_inside_point) {
	typedef typename internal::traits<Derived>::Scalar Scalar;
