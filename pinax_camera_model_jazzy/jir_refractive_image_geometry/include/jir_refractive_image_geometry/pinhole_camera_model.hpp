...
#include <sensor_msgs::msg/msg/camera_info.hpp>
...
public:
	...
	* \brief Set the camera parameters from the sensor_msgs::msg/CameraInfo message.
	*/
	bool fromCameraInfo(const sensor_msgs::msg::CameraInfoConstPtr& msg) {
	...
	*/
	...
	inline const sensor_msgs::msg::CameraInfo& cameraInfo() const  { return cam_info_; }
